...
class V2CardHandler:
    ...
    def read_character_data(self, image):
        ...
        try:
                ...
                try:
                    ...
                    if chara_data.startswith('eyJ'):
                        ...
                        if data.get('spec') == 'chara_card_v2':
                            ...
                            converted = self.convert_v1_to_v2(data)
                            if converted:
                                return converted
                except Exception as e:
            ...
            # No existing character data found - create new empty character
            self.logger.log_step("No existing character data - creating new V2 card")
            empty_card = self.create_empty_v2_card()
            self.logger.log_step("Created empty V2 card:", empty_card)
            
            # Return empty card directly to maintain consistent return format
            return empty_card
