...
def create_spec_file():
    ...
    try:
        ...
        spec_content = """# GENERATED BY build.py — edits to this file will not survive the next build.
...
a = Analysis(
    ...
    hookspath=[os.path.abspath('scripts/pyinstaller-hooks')],
    hooksconfig={},
    runtime_hooks=['scripts/pyinstaller-hooks/hook-clean_old_mei.py', 'scripts/pyinstaller-hooks/rthook_uvicorn_imports.py'],
    excludes=['tkinter'],
